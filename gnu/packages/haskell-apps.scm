...
(define-public threadscope
  (package
    ...
    (source
      (origin
        ...
        (uri (string-append
               ...
               ".tar.gz"))
        (sha256
          (base32 "0xcj8v6kyk8ss2sg6f32gx84vgx36hfaqb5p3sy3d4vkxan4xwcy"))))
    (build-system haskell-build-system)
    (inputs
      `(("ghc-gtk" ,ghc-gtk)
        ("ghc-cairo" ,ghc-cairo)
    ...
    (description
     "This package provides a graphical viewer for thread profile information
...
Threadscope we can check to see that work is well balanced across the
available processors and spot performance issues relating to garbage
collection or poor load balancing.")
    (license license:bsd-3)))
