         ...
         (add-after 'patch-cargo-checksums 'patch-more-checksums
           (lambda _
             ...
             (with-directory-excursion "dns"
               (generate-all-checksums "../guix-vendor"))
             #t))
         ;; Workspaces fail during 'package
         (delete 'package)
...
(define-public tree-sitter-cli
  (package
    ...
    (source
      (origin
        (method url-fetch)
        (uri (crate-uri "tree-sitter-cli" version))
        (file-name
          (string-append name "-" version ".tar.gz"))
        (sha256
          (base32
            "0sd5siy3j8i78g39pz9r44j882hcfw4i63xpyc4w53hlrza1z4rb"))))
    (build-system cargo-build-system)
    (arguments
      `(#:cargo-inputs
        (("rust-ansi-term" ,rust-ansi-term-0.11)
         ...
         ("rust-tree-sitter-highlight"
          ,rust-tree-sitter-highlight-0.3))
        #:cargo-development-inputs
        (("rust-rand" ,rust-rand-0.6)
